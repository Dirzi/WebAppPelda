...
namespace WebAppPelda.Controllers
{
    public class CustomerController
    {
        ...
        public List<Customer> GetCustomersFromFile()
        {
            ...
            List<Customer> customers = new List<Customer>();
            string[] lines = File.ReadAllLines("CustomerData.txt").Skip(1).ToArray();
            ...
            //{
            //new Customer { Id = 1, Name  = "Alice", Phone = "111-222-333", Score = 90},
            //new Customer { Id = 2, Name  = "Bob", Phone = "111-222-333", Score = 75},
            //new Customer { Id = 3, Name  = "Charlie", Phone = "111-222-333", Score = 85},
            //new Customer { Id = 4, Name  = "Gonzo", Phone = "111-222-333", Score = 40}
            //};
